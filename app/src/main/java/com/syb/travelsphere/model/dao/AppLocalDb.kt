...
import com.syb.travelsphere.model.Converters
...
@TypeConverters(GeoPointConverter::class, TimestampConverter::class, Converters::class) // Register the TypeConverter
